...
use crate::keyring::*;
use cennznet_primitives::types::{AccountId, Block, Signature};
...
impl BenchKeyring {
	...
	pub fn generate_genesis(&self) -> cennznet_runtime::GenesisConfig {
		crate::genesis::config_endowed(false, Some(cennznet_runtime::WASM_BINARY), self.collect_account_ids())
	}
}
