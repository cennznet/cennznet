...
fn should_support_add_new_variant_to_enum() {
	...
	assert_upgrade(EnumV3::B(123) as EnumV3<Vec<u8>>, EnumV4::B(123) as EnumV4<Vec<u8>, i32>);

	assert_upgrade(EnumV3::C(123, 456) as EnumV3<i32>, EnumV4::C(123, 456) as EnumV4<i32, i32>);
	assert_upgrade(EnumV3::C(123, vec![1u8, 2u8]) as EnumV3<Vec<u8>>, EnumV4::C(123, vec![1u8, 2u8]) as EnumV4<Vec<u8>, i32>);
}

#[test]
fn shoul_support_depdent_type_upgrades() {
	assert_upgrade(EnumV3::C(1, EnumV1::A) as EnumV3<EnumV1>, EnumV3::C(1, EnumV2::A) as EnumV3<EnumV2>);
	assert_upgrade(EnumV4::C(1, EnumV2::B(12)) as EnumV4<EnumV2, i32>, EnumV4::C(1, EnumV3::B(12)) as EnumV4<EnumV3<i32>, i32>);
}
