...
use cennznet_primitives::types::{BlockNumber, Hash};
use cennznet_runtime::constants::{asset::SPENDING_ASSET_ID, currency::*};
...
fn bench_execute_block(c: &mut Criterion) {
	c.bench_function_over_inputs(
		"execute blocks",
		|b, strategy| {
			let genesis_config = cennznet_testing::genesis::config(false, Some(COMPACT_CODE));
