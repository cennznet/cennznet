...
/// A commitment signed by GRANDPA validators as part of ETHY protocol.
///
...
/// (see [SignedCommitment]) forms the ETHY protocol.
...
pub struct Commitment<TBlockNumber, TPayload> {
	...
	/// commitments.
	/// ETHY light client is expected to import at least one commitment per epoch,
	/// but is free to import as many as it requires.
	pub block_number: TBlockNumber,

	/// ETHY validator set supposed to sign this commitment.
	///
